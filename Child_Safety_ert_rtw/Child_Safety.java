...
import com.example.Child_Safety.databinding.ActivityMainBinding;
...
public class Child_Safety extends AppCompatActivity implements OnFragmentInteractionListener , SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.Child_Safety.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
    ...
    private Child_Safety thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","Child_Safety"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("Child_Safety.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
public void audioFileReadTerminate(int idx) {
    ...
    private native int naMain(String[] argv, Child_Safety pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("Child_Safety");
    }
